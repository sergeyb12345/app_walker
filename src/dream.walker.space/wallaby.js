...
module.exports = function(wallaby) {
  return {
    files: [
      ...
      { pattern: 'Aurelia/src/**/*.js', load: false },
      { pattern: 'Aurelia/test/unit/setup.js', load: false }

    ],

    tests: [
      { pattern: 'Aurelia/test/unit/**/*.spec.js', load: false }
    ],
    ...
    bootstrap: function(wallaby) {
      ...
      for (; i < len; i++) {
        ...
        System.import('Aurelia/test/unit/setup')
        .then(function () {
